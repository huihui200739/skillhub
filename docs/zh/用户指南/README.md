...
本目录面向 **终端用户、创作者与审核管理员**，说明如何在浏览器中使用 SkillHub（Swarm Skills Hub），以及如何完成 Skill 发布、审核与日常维护。

若你负责 **部署与运维**，请参阅 [安装指导](../安装指导/本地安装/安装指导.md) 与 [Docker 方式安装](../安装指导/Docker方式安装/Windows系统安装.md)。  
若你负责 **接口集成或二次开发**，请参阅 [TeamSkillsHub 接口参考](../接口文档/v1/TeamSkillsHub-接口参考.md)（推荐）、[OpenAPI YAML](../接口文档/v1/TeamSkillsHub.md) 与 [CLI 说明](../../../cli/README.md)。

## 文档索引

| 文档 | 适用读者 | 说明 |
|------|----------|------|
| [新用户入门](./新用户入门.md) | 所有新用户 | 产品定位、典型场景、5 分钟快速体验 |
| [前端操作手册](./前端操作手册.md) | 普通用户、创作者、审核员 | 页面结构、发布/编辑/版本管理、个人中心、审核后台 |
...
- 部署问题：参阅 [安装指导](../安装指导/本地安装/安装指导.md)
