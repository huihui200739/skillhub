...
本目录面向 SkillHub 的开发者和二次集成方，说明主要模块、实现边界和扩展点。

## 文档列表

| 文档 | 说明 |
|---|---|
| [插件包格式](./插件包格式.md) | 五类发布包的公共规则与分类型规范入口 |
| [Tools 格式](./插件类型格式/Tools格式.md) | Python tools 插件的源码、Schema 和 wheel 发布包 |
...
| [推荐系统](./推荐系统/README.md) | 个性化推荐链路、离线任务与模块边界 |
