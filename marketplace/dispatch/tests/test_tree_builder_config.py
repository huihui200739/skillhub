...
from indexing.tree.expansion import TreeExpansionEngine
from indexing.tree.grouping import TreeGroupingEngine
from indexing.tree.schema import DynamicTreeConfig, TreeNode, normalize_root_categories
...
class _FakeTreeBuilder:
    def __init__(self) -> None:
        ...
        self._equiv_allow_singleton_groups = True
