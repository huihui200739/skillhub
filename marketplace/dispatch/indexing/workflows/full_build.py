...
from indexing.models import TREE_INDEX_FILENAME
from indexing.scanners import create_scanner, normalize_item_type
...
from indexing.workflows.item_sources import ResolvedItemPath, resolve_materialized_item_paths
from indexing.workflows.output_writer import unlink_if_exists, write_index_outputs
    ...
    def __init__(
        ...
        *,
        ...
        self._manifest_item_paths = [
            str(path).strip()
            for path in (manifest_item_paths or self._item_paths)
            if str(path).strip()
        ]
        ...
        *,
        ...
        if can_build_tree_with_llm(self._config):
            ...
            with timer.phase("build_tree_llm"):
                from indexing.workflows import index_builder as public_module
                ...
                return public_module.build_tree(
                    ...
                    show_tree=False,
                    display_skills_dir=(
                        self._infer_display_skills_dir(resolved_item_paths)
