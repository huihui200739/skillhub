...
FIXED_ROOT_CATEGORIES = {
    "search-research": {
        ...
        "description": "Search, retrieval, paper reading, content extraction, user research, and trend analysis skills.",
    },
    "writing-editing": {
        "name": "Writing & Editing",
        "description": "Writing, rewriting, reporting, copywriting, style transfer, and creative text generation skills.",
    },
    "visual-media": {
        "name": "Visual & Media",
        "description": "Visual design, image generation, brand assets, slides, UI design, scene design, and image understanding skills.",
    },
    "business-analysis": {
        "name": "Business & Analysis",
        "description": "Finance, market analysis, investment intelligence, reporting, and data analysis skills.",
    },
    "planning-agents": {
        "name": "Planning & Agents",
        "description": "Agent building, planning, proactive execution, personal knowledge, personas, and workflow coordination skills.",
    },
    "product-dev": {
        "name": "Product & Dev",
        "description": "Product documentation, testing, deployment, frontend engineering, and software delivery skills.",
    },
    "lifestyle-utility": {
        "name": "Lifestyle & Utility",
        "description": "Weather, health, habit, map, and other practical everyday utility skills.",
    },
}
            ...
            if isinstance(entry, str):
                ...
                if raw_children is not None:
                    if not isinstance(raw_children, list):
                        raise ValueError(f"{label_path} item '{category_id}' children must be a list.")
                    children = normalize_entries(raw_children, label_path=f"{label_path}.{category_id}.children")
                    if children:
