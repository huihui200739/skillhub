...
def build_finder_system_prompt(*, tree_cid_hierarchy: str, top_k: int) -> str:
...
def build_finder_catalog_prompt(*, choices, top_k: int) -> str:
    resolved_top_k = max(1, int(top_k or 1))
    lines = [
        "/no_think",
        "",
...
__all__ = ["build_finder_catalog_prompt", "build_finder_system_prompt"]
