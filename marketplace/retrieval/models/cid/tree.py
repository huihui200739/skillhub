...
from .cid import CID
from .node_spec import NodeSpec, NodeType
...
class CIDTree:
    ...
    def from_yaml(cls, preset: str, logger: logging.Logger | None = None) -> "CIDTree":
        ...
        if not isinstance(data, dict):
            raise ValueError(
                "Preset content must deserialize to a mapping with optional "
                "'routing_policy', 'tree_sketch', and 'nodes' fields"
            )
