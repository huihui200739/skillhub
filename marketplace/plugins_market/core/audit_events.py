...
class Action:
    ...
    AUTO_REVIEW_SYSTEM_FAILED = "AUTO_REVIEW_SYSTEM_FAILED"
    PENDING_MODERATION_SET = "PENDING_MODERATION_SET"
    EXPORT = "EXPORT"
    DOWNLOAD = "DOWNLOAD"
...
ALL_ACTIONS: tuple[str, ...] = (
    ...
    Action.AUTO_REVIEW_SYSTEM_FAILED,
    Action.PENDING_MODERATION_SET,
    Action.EXPORT,
    Action.DOWNLOAD,
)
